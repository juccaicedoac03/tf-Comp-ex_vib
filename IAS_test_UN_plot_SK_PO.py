...
plt.savefig('figures/Test_UN_PO_baseline00.pdf', bbox_inches='tight')
# %% loading data
filed = 'Data/Test_17_PO_STASK'
mat_contents = sio.loadmat(filed, mdict=None, appendmat=True)
...
for xc in xcoords:
    plt.axvline(x=xc, color='red', linestyle=':')
plt.savefig('figures/Test_UN_PO_baseline01.pdf', bbox_inches='tight')
# %% Proposed STASK
filed = 'Data/Test_17_PO_STASK'
mat_contents = sio.loadmat(filed, mdict=None, appendmat=True)
...
sp = mat_contents['psd_env_save'][:,2]
...
for xc in xcoords:
    plt.axvline(x=xc, color='red', linestyle=':')
plt.savefig('figures/Test_UN_PO_STASK.pdf', bbox_inches='tight')